...
parser = argparse.ArgumentParser(
    description="Train the controlled Double DQN soft-update experiment."
)
parser.add_argument(
    "--seed",
    type=int,
...
# This branch changes only the target-network update strategy relative to base.
EXPERIMENT_VARIANT = "double_dqn_soft_update_only"
